...
public class CustomerController {
	...
	public CustomerDetails getCutomer(@PathVariable int id)
	{
		return service.getCustomer(id); //Using get it will convert from optional to Customer type
	}
	
	@RequestMapping(method = RequestMethod.POST, value = "/customers")
	public void addCustomer( @RequestBody CustomerDetails listElement)
	{
		service.addCustomer(listElement);
	}
	@RequestMapping(method = RequestMethod.PUT, value = "/customers/{id}")
	public void updateCustomer( @RequestBody CustomerDetails listElement)
	{
