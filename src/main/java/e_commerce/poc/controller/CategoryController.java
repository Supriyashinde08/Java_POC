...
public class CategoryController {
	...
	public CatgEnty getCategory(@PathVariable int id)
	{
	...
	public void addCategory( @RequestBody CatgEnty listElement)
	{
	...
	public void updateCategory( @RequestBody CatgEnty listElement)
	{
